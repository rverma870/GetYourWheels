...
function AboutUs() {
  return (
    <>
      <div className="container bg-white my-4 p-3 rounded ">
        <h4>About MyWheels</h4>
        <p>
          MyWheels.com is India's leading car search venture that helps users
        ...
        <p>
          MyWheels.com has launched many innovative features to ensure that
          ...
          The platform also has used car classifieds wherein users can upload
          their cars for sale, and find used cars for buying from individuals
          and used car dealers.
        </p>
        <p>
          Besides the above consumer product features, MyWheels.com provides a
          rich array of tech-enabled tools to OE manufacturers and car dealers.
          These include apps for dealer sales executives to manage leads, cloud
        ...
        <p>
          ...
          batteries, insurance or roadside assistance.
        </p>
        <p>
          To diversify our product offerings we have ventured into car insurance
          business through MyWheelsInsurance.Com
        </p>
      </div>
    </>
  );
